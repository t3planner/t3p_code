...
def OWAN(
    dataset, original_graph:nx.Graph, add_list:list, original_traffic:dict, alpha=0.95, division=10, ring_len=10
): 
    ...
    fiber_net, load_graph, traffic_paths = simulated_annealing(G, graph, add_list, traffic, alpha, division, ring_len)
