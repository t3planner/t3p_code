...
from MLBO.main import MLBO
from Optimal_solution.main import Optimal_solution
from Mesh_Optimal_solution.main import Mesh_Optimal_solution
from NeuroPlan.main import NeuroPlan
from Ring_Optimal_solution.main import Ring_Optimal_solution
from RingMesh_Optimal_solution.main import RingMesh_Optimal_solution
from OWAN.main import OWAN
from OWAN_roedunet.main import OWAN_roedunet
...
if __name__ == '__main__':
    ...
    if args.method == 'MLBO': 
        MLBO(args.dataset, G_IP, traffic, SRLG, ring_len=args.max_nodes)
    elif args.method == 'Optimal_solution':
        Optimal_solution(args.dataset, G_IP, traffic, SRLG, args.time_limit)
    elif args.method == 'Mesh_Optimal_solution':
        Mesh_Optimal_solution(args.dataset, G_IP, traffic, SRLG, args.time_limit)
    elif args.method == 'NeuroPlan': 
        NeuroPlan(
            args.dataset, G_IP, traffic, SRLG, 
            args.delta_load, args.max_deltas, args.feature_dim, args.time_limit
        )
    elif args.method == 'Ring_Optimal_solution':
        Ring_Optimal_solution(args.dataset, G_IP, traffic, SRLG, args.max_nodes, args.max_rings, args.time_limit)
    elif args.method == 'RingMesh_Optimal_solution':
        RingMesh_Optimal_solution(args.dataset, G_IP, traffic, SRLG, args.max_nodes, args.max_rings, args.time_limit)
    elif args.method == 'OWAN': 
        OWAN(args.dataset, G_IP, traffic, SRLG, alpha=0.95, division=5, ring_len=args.max_nodes)
    elif args.method == 'OWAN_roedunet': 
        OWAN_roedunet(args.dataset, G_IP, traffic, SRLG, alpha=0.95, division=5)
    elif args.method == 'Rule':
        Rule(args.dataset, G_IP, traffic, SRLG)
    else: 
